...
导入Apifox
![step1](API/img/db7e6fe63c00b2135492598810b94fca.png)

## 使用Apifox进行Mock
![step2](API/img/bd7e9bfcf04d7cd809bea7875abf2217.png)

## 功能测试
以测试用户注册登录查询为例，开始功能测试
![step3](API/img/d8cac2028fc5308f9f4533b668d8147e.png)
测试成功
![step4](API/img/c55fbc93a2546b9d44c78fcdc3d723f2.png)

## 设置断言
以获取图书列表为例，判断其库存数目是否为0
![step4](API/img/da902fef93cacb2882a1b782760e92d1.png)
断言判断成功
![step5](API/img/1eb313ba27455508d1d1ea86d13b8eff.png)

## 性能测试
以数据库管理操作为例
![step6](API/img/da4ffa5eb400f6b1a3490a127354678e.png)
